...
Eigen::Vector2d MyGDSalgo::cal_gradient(
    ...
    double fx = MyGDSalgo::potential_att(q, q_goal) + MyGDSalgo::potential_rep(q, problem);
    
    Eigen::Vector2d q1 ={q[0]+h, q[1]};
    double fx_plus_h_x = MyGDSalgo::potential_att(q1, q_goal) + MyGDSalgo::potential_rep(q1, problem);
    Eigen::Vector2d q2 ={q[0]-h, q[1]};
    double fx_minus_h_x = MyGDSalgo::potential_att(q2, q_goal) + MyGDSalgo::potential_rep(q2, problem);
    Eigen::Vector2d q3 ={q[0], q[1]+h};
    double fx_plus_h_y = MyGDSalgo::potential_att(q3, q_goal) + MyGDSalgo::potential_rep(q3, problem);
    Eigen::Vector2d q4 ={q[0], q[1]-h};
    double fx_minus_h_y = MyGDSalgo::potential_att(q4, q_goal) + MyGDSalgo::potential_rep(q4, problem);
