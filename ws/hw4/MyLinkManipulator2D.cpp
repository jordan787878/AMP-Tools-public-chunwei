...
MyLinkManipulator2D::MyLinkManipulator2D(const LinkManipulator2D& baseobj): LinkManipulator2D(baseobj){}
...
Eigen::Vector2d MyLinkManipulator2D::getJointLocation(const ManipulatorState& state, uint32_t joint_index) const {
...
ManipulatorState MyLinkManipulator2D::inverseKinematics(const Eigen::Vector2d& endEffectorPos, 
